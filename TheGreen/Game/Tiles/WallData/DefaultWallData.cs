...
namespace TheGreen.Game.Tiles.WallData
{
    public class DefaultWallData
    {
        ...
        {
            spriteBatch.Draw(ContentLoader.WallTextures[WallID], new Vector2(x * TheGreen.TILESIZE - 2, y * TheGreen.TILESIZE - 2), TileDatabase.GetWallTextureAtlas(WorldGen.World.GetWallState(x, y)), Main.LightEngine.GetLight(x, y));
        }
    }
}
