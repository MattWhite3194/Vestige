...
namespace TheGreen.Game
{
    ...
    public class Main
    {
        ...
        public Main(Player player, GraphicsDevice graphicsDevice)
        {
            ...
            ParallaxManager.AddParallaxBackground(new ParallaxBackground(ContentLoader.MountainsBackground, new Vector2(0.01f, 0.001f), EntityManager.GetPlayer().Position, (WorldGen.World.SurfaceDepth + 20) * Globals.TILESIZE, (WorldGen.World.SurfaceDepth - 80) * Globals.TILESIZE));
            ParallaxManager.AddParallaxBackground(new ParallaxBackground(ContentLoader.TreesFarthestBackground, new Vector2(0.1f, 0.06f), EntityManager.GetPlayer().Position, (WorldGen.World.SurfaceDepth + 5) * Globals.TILESIZE, (WorldGen.World.SurfaceDepth - 30) * Globals.TILESIZE));
            ParallaxManager.AddParallaxBackground(new ParallaxBackground(ContentLoader.TreesFartherBackground, new Vector2(0.2f, 0.08f), EntityManager.GetPlayer().Position, (WorldGen.World.SurfaceDepth + 5) * Globals.TILESIZE, (WorldGen.World.SurfaceDepth - 30) * Globals.TILESIZE));
            ParallaxManager.AddParallaxBackground(new ParallaxBackground(ContentLoader.TreesBackground, new Vector2(0.3f, 0.1f), EntityManager.GetPlayer().Position, (WorldGen.World.SurfaceDepth + 5) * Globals.TILESIZE, (WorldGen.World.SurfaceDepth - 30) * Globals.TILESIZE));
        }
        public void Update(double delta)
        {
            Globals.UpdateGameTime(delta);
            WorldGen.World.Update(delta);
            ParallaxManager.Update(delta, GetCameraPosition() + Globals.ScreenCenter.ToVector2());
